...
const mintCNFT = async () => {
  ...
  //Collection ID = CpBwCknzCTdn71uew7tE8qFwTqqccPmgRfPpWgDyMyV4
  //merkleTree = 3rqL5frM458MRQbqEBsqJmXgUv13yBmyb5wAPPserWSN
  // MAINNET
  const collectionMintPublicKey = publicKey(
    "CpBwCknzCTdn71uew7tE8qFwTqqccPmgRfPpWgDyMyV4",
  ); // Collection Mint Address
  const merkleTreePublicKey = publicKey(
    "3rqL5frM458MRQbqEBsqJmXgUv13yBmyb5wAPPserWSN",
